...
SECRET_KEY = 'django-insecure-k=dru-h$g=1@r+ylhhu4i-oo8-*$*s$qds+ym%d@oir=_drykh'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'kintai', 'static'),
]
...
# アップロードされたファイルを保存するディレクトリの場所
MEDIA_ROOT = BASE_DIR / 'media'

# アップロードされたファイルにアクセスするためのURL
MEDIA_URL = '/media/'

# ファイルアップロードサイズの設定
# 最大アップロードサイズを50MBに設定（スマホ写真対応）
